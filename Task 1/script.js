...
function displayConvertedValues(kilograms) {
  ...
  crEl(
    "p",
    "convertedValue",
    allHTMLEls.convertedContainer,
    `${kilograms} kg = ${calcLb(kilograms)} pounds (lb)`
  );
  crEl(
    "p",
    "convertedValue",
    allHTMLEls.convertedContainer,
    `${kilograms} kg = ${calcG(kilograms)} grams (g)`
  );
  crEl(
    "p",
    "convertedValue",
    allHTMLEls.convertedContainer,
    `${kilograms} kg = ${calcOz(kilograms)} ounces (oz)`
  );
}
